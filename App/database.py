...
#Creat a function to initialize the database
def get_migrate(app):
...
#Create a function to drop the database
def init_db(app):
    db.init_app(app)
...
#Create Amenities
        ...
        landlords = [
            Landlord(name='John', email='john@email.com', password=generate_password_hash('password123', method='scrypt'), phone_number='123-456-7890'),
        ...
        tenants = [
            Tenant(name='Alice', email='alice@email.com', password=generate_password_hash('alicepass', method='scrypt'), apartment_id=1),
...
#Create Apartments
        apartments = [
            Apartment(apartment_name='Apartment 1', apartment_location='123 Sesame St', landlord_id=1, number_of_units_total=10, number_of_units_available=5, number_of_units_not_available=5, apartment_details='One rooms'),
